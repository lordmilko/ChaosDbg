...
namespace ChaosDbg.Metadata
{
    ...
    public interface IImageOptionalHeader
    {
        ...
        /// </summary>
        int SizeOfInitializedData { get; }

        /// <summary>
        /// The size of the uninitialized data section (BSS), or the sum of all such sections if there are multiple BSS sections.
        /// </summary>
        int SizeOfUninitializedData { get; }
        ...
        ImageDllCharacteristics DllCharacteristics { get; }
        ...
        /// </remarks>
        IImageDataDirectory CopyrightTableDirectory { get; }
    ...
    /// Represents the IMAGE_OPTIONAL_HEADER structure.
    /// </summary>
    public struct ImageOptionalHeader : IImageOptionalHeader
    {
        #region Standard fields
