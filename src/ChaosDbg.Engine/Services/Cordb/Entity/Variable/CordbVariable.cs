...
{
    /// <summary>
    /// Represents either an argument or local variable passed into a function.
    /// </summary>
    public abstract class CordbVariable
    {
        ...
        protected CordbVariable(CorDebugVariableHome corDebugVariableHome, CordbModule module)
        {
