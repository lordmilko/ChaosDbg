...
{
    public interface ISigType
    {
        CorElementType Type { get; }
    }

    public class SigType : ISigType
    {
        public static readonly SigType Sentinel = new SigType(CorElementType.Sentinel);

        public CorElementType Type { get; }

        internal static SigType New(ref SigReaderInternal reader)
        {
        ...
        private static SigType NewGenericType(ref SigReaderInternal reader)
        {
